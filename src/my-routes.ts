export const MY_ROUTES = {
    ...
    adminPages: {
        ...
        career: {
            base: 'careers',
            absolute: '/main/admin/careers',
            form: {
                base: 'careers/form',
                absolute: '/main/admin/careers/form'
            }
        },
        institution: {
            base: 'institutions',
            ...
            form: {
                base: 'institutions/form',
                absolute: '/main/admin/institutions/form'
            }
        },
        schoolPeriod: {
            base: 'school-periods',
            absolute: '/main/admin/school-periods',
            form: {
                base: 'school-periods/form',
                absolute: '/main/admin/school-periods/form'
            }
        },
        subject: {
            base: 'subjects',
